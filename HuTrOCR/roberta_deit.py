...
parser.add_argument("--working_dir", type=str, default='Models/Roberta-base_Deit')
...
class OCRDataset(Dataset):
    def __init__(self, root_dir, df, processor, tokenizer, max_target_length= args.max_length):
